...
class FirewallTest extends PHPUnit_Framework_TestCase
{
    private function getPoolsConfig($poolId = 'internet', array $configOverride = [])
    {
        ...
        return ['default' => new Pools($poolsConfig)];
    }
    ...
    public function testDefaultFirewall()
    {
        $this->assertSame(
            [
                ...
                '-N vpn-default-internet',
                '-A FORWARD -i tun-default-internet+ -s 10.93.163.0/24 -j vpn-default-internet',
                '-A vpn-default-internet -o eth0 -j ACCEPT',
        ...
        $this->assertSame(
            [
                ...
                '-A FORWARD -m state --state ESTABLISHED,RELATED -j ACCEPT',
                '-N vpn-default-internet',
                '-A FORWARD -i tun-default-internet+ -s fdbc:dfcc:f434:e740::/60 -j vpn-default-internet',
                '-A vpn-default-internet -o eth0 -j ACCEPT',
    ...
    public function testBlockSmb()
    {
        $this->assertSame(
            [
                ...
                '-N vpn-default-internet',
                '-A FORWARD -i tun-default-internet+ -s 10.93.163.0/24 -j vpn-default-internet',
                '-A vpn-default-internet -o eth0 -m multiport -p tcp --dports 137:139,445 -j REJECT --reject-with icmp-host-prohibited',
                '-A vpn-default-internet -o eth0 -m multiport -p udp --dports 137:139,445 -j REJECT --reject-with icmp-host-prohibited',
                '-A vpn-default-internet -o eth0 -j ACCEPT',
                '-A FORWARD -j REJECT --reject-with icmp-host-prohibited',
                'COMMIT',
            ],
    ...
    public function testNoDefaultGateway()
    {
        $this->assertSame(
            [
                ...
                '-N vpn-default-internet',
                '-A FORWARD -i tun-default-internet+ -s 10.93.163.0/24 -j vpn-default-internet',
                '-A vpn-default-internet -o eth0 -d 192.168.42.0/24 -j ACCEPT',
                '-A FORWARD -j REJECT --reject-with icmp-host-prohibited',
                'COMMIT',
            ],
        ...
        $this->assertSame(
            [
                ...
                '-N vpn-default-internet',
                '-A FORWARD -i tun-default-internet+ -s fdbc:dfcc:f434:e740::/60 -j vpn-default-internet',
                '-A vpn-default-internet -o eth0 -d fd00:1234:1234::/48 -j ACCEPT',
                '-A FORWARD -j REJECT --reject-with icmp6-adm-prohibited',
                'COMMIT',
            ],
